...
{
    private static readonly ClaimsPrincipal SampleClaimsPrincipal =
        new(
            new ClaimsIdentity(
                new Claim[]
                {
                    new("sub", "38487af9-f46b-4daf-bc23-b69358c6c9ce"),
                    new("role", "user"),
                },
                "scheme",
                "sub",
    ...
    private static readonly JsonSerializerOptions SerializerOptions =
        new() { Converters = { new ClaimsPrincipalJsonConverter() } };
